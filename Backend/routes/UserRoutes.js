...
import { createUser, getAllUsers, getUserProfile, updateUserEmail, updateUserProfile } from "../controllers/UserController.js";
...
usersRouter.put('/update-email', Authuser, updateUserEmail)
